...
class ResiduoRepository {
    ...
    private val residuos = listOf<Residuo>(
        ...
        Residuo(2, "Computador","XPTO2", 2, R.drawable.ic_computer_black_24dp),
        Residuo(3, "Teclado","XPTO3", 3, R.drawable.ic_keyboard_black_24dp),
        Residuo(4, "Mémoria","XPTO4", 4, R.drawable.ic_memory_black_24dp),
        Residuo(5, "Smartphone","XPTO5", 5, R.drawable.ic_smartphone_black_24dp)
    )
